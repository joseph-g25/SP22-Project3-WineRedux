"""
Custom-made tools for efficient creation and use of KMeans tools
"""
...
def KMeans_cluster_load(X, n_clusters,
                        n_init=10,
                        max_iter=300,
    ...
    Args:
        ...
        max_iter (int, optional): Number of iterations to converge on a clustering solution.
        Defaults to 300.
...
def mini_KMeans_cluster_load(X, n_clusters=8,
                             n_init=10,
                             max_iter=300,
                             random_state=RANDOM_STATE):
    ...
    Args:
        ...
        max_iter (int, optional): Maximum number of iterations over the complete dataset before
        stopping independently of any early stopping criterion heuristics. Defaults to 300.
        random_state (int, optional): Set random state seed. Defaults to RANDOM_STATE.
...
def make_kmeans_set(X,
                    ...
                    random_state = RANDOM_STATE):
    """
    Create a list of kmeans clustering algorithms with [0<n, n+j] n_clusters set as parameters.

    Args:
        X (list/DataFrame/array/series): [description]
        range_lower (int, optional): Lower bound of n_clusters. Defaults to 1.
        range_upper (int, optional): Upper bound of n_clusters. Defaults to 10.
        step (int, optional): Step size between n_clusters values. Defaults to 1.

    Returns:
        [type]: [description]
    """
    kmeans_set = [KMeans_cluster_load(X=X,
                                      n_clusters=k,
                                      n_init=n_init,
                                      max_iter=max_iter,
                                      random_state=random_state)
...
def get_silhouette_scores(X, range_lower=2,
                          range_upper=10,
                          step=1,
                          kmeans_set=None,
                          return_kmeans_set=False):
    """
    ...
    Args:
        ...
        kmeans_set (list, optional): List of KMeans classifiers to calculate silhouette scores of.
        Defaults to None.
        return_kmeans_set (bool, optional): If True and kmeans_set is None,
        returns the generated list of KMeans classifiers.
